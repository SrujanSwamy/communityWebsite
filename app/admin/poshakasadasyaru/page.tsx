...
function ManagePoshakaSadasyaruPage() {
  const [members, setMembers] = useState<PoshakaSadasyaru[]>([]);
  const [editingMember, setEditingMember] = useState<PoshakaSadasyaru | null>(null);
  ...
  const openEditDialog = (member: PoshakaSadasyaru) => {
      ...
      <div className="container mx-auto">
        <Card className="bg-white border-2 border-[#B22222] mb-8">
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle className="text-[#B22222]">Manage Poshaka Sadasyaru</CardTitle>
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Add a new member to Poshaka Sadasyaru
                  </DialogDescription>
                </DialogHeader>
...
export default ManagePoshakaSadasyaruPage;