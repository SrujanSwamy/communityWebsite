...
export default function MahaposhakaruPage() {
  ...
  const [selectedMember, setSelectedMember] = useState<Mahaposhaka | null>(null)
  const [loading, setLoading] = useState(true)
  const [searchTerm, setSearchTerm] = useState("")
  const [currentPage, setCurrentPage] = useState(1)
  const [totalMembers, setTotalMembers] = useState(0)
  const [filteredMembers, setFilteredMembers] = useState<Mahaposhaka[]>([])
      ...
      <div className="min-h-screen bg-[#FFF9E6] py-8 px-4">
        <div className="container mx-auto">
          <div className="bg-black py-6 mb-12">
            <h1 className="text-3xl font-bold text-center text-white">Mahaposhakaru</h1>
          </div>
              ...
              >
                ...
                <CardContent className="text-center pt-0">
                  <CardTitle className="text-lg font-semibold text-[#4A2C2A] mb-2">
                    {member.name || "Mahaposhaka"}
                  </CardTitle>
                  {member.designation && (
                    <p className="text-[#B22222] text-sm">
                      {member.designation}
                    </p>
                  )}
                </CardContent>
              ...
              <DialogHeader>
                <DialogTitle className="text-2xl text-[#B22222] flex flex-col items-center mb-4">
                  ...
                  <div className="text-center">
                    <h2 className="text-2xl">{selectedMember.name || "Mahaposhaka"}</h2>
                ...
                <DialogDescription className="text-center">
                  {selectedMember.designation ? (
                    ...
                    <p className="text-[#4A2C2A]">Mahaposhaka</p>
                  )}
                </DialogDescription>
              </DialogHeader>
            </DialogContent>
