...
export default function PoshakaSadasyaruPage() {
  ...
  const [filteredMembers, setFilteredMembers] = useState<PoshakaSadasya[]>([])
      ...
      <div className="min-h-screen bg-[#FFF9E6] py-8 px-4">
        <div className="container mx-auto">
          <div className="bg-black py-6 mb-12">
            <h1 className="text-3xl font-bold text-center text-white">Poshaka Sadasyaru</h1>
          </div>
              ...
              <DialogHeader>
                ...
                <DialogDescription className="text-center">
                  {selectedMember.designation ? (
                    ...
                    <p className="text-[#4A2C2A]">Poshaka Sadasya</p>
                  )}
                </DialogDescription>
              </DialogHeader>
            </DialogContent>
