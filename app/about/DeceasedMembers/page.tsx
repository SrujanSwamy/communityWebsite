...
import { User, Search, ChevronLeft, ChevronRight, Heart } from "lucide-react"
...
export default function DeceasedMembersPage() {
  ...
  const [filteredMembers, setFilteredMembers] = useState<DeceasedMember[]>([])
      ...
      <div className="min-h-screen bg-[#FFF9E6] py-8 px-4">
        <div className="container mx-auto">
          <div className="bg-black py-6 mb-12">
            <h1 className="text-3xl font-bold text-center text-white">In Loving Memory</h1>
            <p className="text-center text-white mt-2 opacity-75">Deceased Members</p>
          </div>
            ...
            >
              ...
              >
                ...
                <CardHeader className="flex items-center justify-center pb-4">
                  ...
                  <div className={`w-24 h-24 bg-gray-600 rounded-full flex items-center justify-center ${member.photo ? 'hidden fallback-avatar' : ''}`}>
              ...
              <DialogHeader>
                <DialogTitle className="text-2xl text-[#B22222] flex flex-col items-center mb-4">
                  <div className="mb-4 relative">
                    ...
                    <div className={`w-30 h-30 bg-gray-600 rounded-full flex items-center justify-center relative ${selectedMember.photo ? 'hidden fallback-avatar' : ''}`}>
                  ...
                  <div className="text-center">
                    <h2 className="text-2xl">{selectedMember.name || "Unknown Member"}</h2>
                ...
                <DialogDescription className="text-center">
                  <div className="space-y-2">
                    <div className="flex items-center justify-center">
                      <Heart className="w-4 h-4 mr-2 text-[#B22222]" />
                      <span className="text-[#4A2C2A] text-base">Always remembered</span>
                    </div>
